...
def setup():
    ...
    fig = ff.create_distplot([mean_list], ["Reading Time"], show_hist = False, colors = ['#0BA1E3'])
    fig.add_trace(go.Scatter(x = [mean_of_sample_1, mean_of_sample_1], y = [0, 1], mode = "lines", name = "Sample Mean"))
    ...
    fig.add_trace(go.Scatter(x = [third_std_dev_end, third_std_dev_end], y = [0, 1], mode = "lines", name = "Third Standard Deviation End"))
